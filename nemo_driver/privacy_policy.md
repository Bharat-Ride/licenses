...
**Application** means the software program provided by the Company downloaded by You on any electronic device, named betterride driver

**Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to betterride driver.
...
**With other users:** when You share location information during an active trip, we may share your live location information with parents to track the location for their child.
